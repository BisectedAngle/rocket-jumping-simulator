...
var healing_positions = [Vector2(1800,100), Vector2(120,100), Vector2(313,412), Vector2(1620,412)]
...
func spawn_walker():
	...
	walker.global_position = Vector2(260,60)
	get_tree().current_scene.add_child(walker)

func spawn_jumper():
	jumpers += 1
	var jumper = jumper_scene.instantiate()
	jumper.global_position = Vector2(1700,60)
