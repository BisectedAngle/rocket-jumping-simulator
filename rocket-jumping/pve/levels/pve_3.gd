...
@export var max_walkers = 3
@export var max_jumpers = 3
@export var walker_goal = 5
@export var jumper_goal = 5
...
func spawn_healing():
	if !healing_exist:
		...
		var healing_x = [rng.randi_range(140, 765),rng.randi_range(1180, 1770)].pick_random()
		var healing_y = rng.randi_range(130, 1000)
		healing.global_position = Vector2(healing_x, healing_y)
